...
class CollectorConfig {
 public:
  ...
  const std::optional<std::string>& GetNatsUrl() const { return nats_url_; }
 ...
 protected:
  ...
  // URL to the NATS broker (e.g., nats://acs-broker:4222)
  std::optional<std::string> nats_url_;

  // Cluster identifier for NATS subject naming
  std::string cluster_id_ = "local";
